//src/app/features/resources/index.ts
// Public API for the resources feature module
...
export * from './components/rds-resources/rds-resources.component';
export * from './components/s3-resources/s3-resources.component';
